    ...
    <div v-else-if="game">
      ...
      <v-row class="mb-6">
        <v-col cols="12" md="6">
          <TeamLineup
            :team-number="1"
            :players="teamPlayers?.team_1 || []"
            @add-player="openAddPlayerDialog(1)"
          />
        </v-col>
        <v-col cols="12" md="6">
          <TeamLineup
            :team-number="2"
            :players="teamPlayers?.team_2 || []"
            @add-player="openAddPlayerDialog(2)"
          />
        </v-col>
      </v-row>
      ...
      <!-- Goals Timeline -->
      <GoalsList
        v-if="game.goals && game.goals.length > 0"
        :goals="game.goals"
        :game-start-time="game.date"
      />
